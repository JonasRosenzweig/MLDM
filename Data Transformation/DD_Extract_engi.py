...
PATH = r'C:\Users\mail\PycharmProjects\MLDM\Data\Final\NAME_NUM_OTHER.csv'
...
os.chdir(r'C:\Users\mail\PycharmProjects\MLDM\Data\Final')

cols2DF(df_test, 'NAME_NUM_OTHER_test_2D.csv')

cols2DF(df_train, 'NAME_NUM_OTHER_train_2D.csv')

ros = RandomOverSampler(random_state=0)

df_train_2D = pd.read_csv(r'C:\Users\mail\PycharmProjects\MLDM\Data\Final\NAME_NUM_OTHER_train_2D.csv',
...
Data_Oversampled.to_csv('NAME_NUM_OTHER_train_2D_over.csv', index=False)
